...
export default {
  ...
  setup () {
    ...
    const validateState = () => {
      nomenclatureState.value = weapon.value.nomenclatura !== null && weapon.value.nomenclatura !== ''
      brandState.value = weapon.value.marca !== null && weapon.value.marca !== ''
      typeWeaponState.value = weapon.value.tipoArma !== null && weapon.value.tipoArma !== ''
      gaugeState.value = weapon.value.calibre !== null && weapon.value.calibre !== ''

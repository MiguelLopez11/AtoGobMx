...
export default {
  ...
  setup (props) {
    ...
    getDocumentsObrasPublicas(props.ObraId, data => {
    ...
    const submitFiles = () => {
      ...
      createDocumentsObrasPublicas(props.ObraId, formData, data => {
    ...
    const RemoveDocument = archivoId => {
      swal
        ...
        .then(result => {
          if (result.isConfirmed) {
            deleteDocumentsObrasPublicas(props.ObraId, archivoId, data => {
              swal
                .fire({

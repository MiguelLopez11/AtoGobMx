...
export default {
  ...
  setup (props) {
    const { getDocumentsObrasPublicas, deleteDocumentsObrasPublicas, createDocumentsObrasPublicas } = FileServices()
    ...
    getDocumentsObrasPublicas(props.ExpedientDigitalId, data => {
    ...
    const submitFilesPublicWorks = () => {
      ...
      createDocumentsObrasPublicas(props.ExpedientDigitalId, formData, data => {
        ...
        .then(result => {
          if (result.isConfirmed) {
            swal
              ...
              .then(result => {
                if (result.isConfirmed) {
                  deleteDocumentsObrasPublicas(props.ExpedientDigitalId, archivoId, data => {
                    showModal.value = false
                    refreshTable()
                  })
                }

...
namespace AtoGobMx.Migrations
{
    ...
    [Migration("20230119235610_User_Employee")]
    partial class User_Employee
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtoGobMx.Models.ArchivosAseo", b =>
                {
                    ...
                    b.HasKey("ArchivosAseoId");

                    b.HasIndex("AseoId");

                    b.ToTable("ArchivosAseo");
                });
            ...
            modelBuilder.Entity("AtoGobMx.Models.ArchivosEquipoComputo", b =>
                {
                    b.Property<int>("ArchivoEquipoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("ArchivoEquipoId");

                    b.HasIndex("EquipoComputoId");

                    b.ToTable("ArchivosEquipoComputos");
                });

            modelBuilder.Entity("AtoGobMx.Models.ArchivosMobiliario", b =>
                {
                    b.Property<int>("ArchivoMobiliarioId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("ArchivoMobiliarioId");

                    b.HasIndex("MobiliarioId");

                    b.ToTable("ArchivosMobiliarios");
                });

            modelBuilder.Entity("AtoGobMx.Models.ArchivosObras", b =>
                {
                    b.Property<int>("ArchivosObrasId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AtoGobMx.Models.AseoEmpleado", b =>
                {
                    b.Property<int>("AseoEmpleadoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("AseoEmpleadoId");

                    b.HasIndex("EmpleadoId");

                    b.HasIndex("RutaId");

                    b.ToTable("AseoEmpleado");
                });

            modelBuilder.Entity("AtoGobMx.Models.AseoVehiculo", b =>
                {
                    b.Property<int>("AseoVehiculoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("AseoVehiculoId");

                    b.HasIndex("RutaId");

                    b.HasIndex("VehiculoId");

                    b.ToTable("AseoVehiculo");
                });

            modelBuilder.Entity("AtoGobMx.Models.Cementerio", b =>
                {
                    b.Property<int>("CementerioId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AtoGobMx.Models.Empleado", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NombreCompleto = "Rogelio Gonzales Camacho",
                            PuestoTrabajoId = 1,
            ...
            modelBuilder.Entity("AtoGobMx.Models.Gabetas", b =>
                {
                    b.Property<int>("GabetaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MetrosCorrespondientes")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("AtoGobMx.Models.OP_Vehiculos", b =>
                {
                    b.Property<int>("OpVehiculoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("OpVehiculoId");

                    b.HasIndex("ObraId");

                    b.HasIndex("VehiculoId");

                    b.ToTable("OP_Vehiculos");
                });
            ...
            modelBuilder.Entity("AtoGobMx.Models.PROV_EstatusVale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EstatusValeId = 1,
                            Archivado = false,
                            Descripcion = "Se ha generado el vale para ser validado por el director del departamento de Proveeduría",
                            Nombre = "Pendiente"
                        },
                        new
                        {
                            EstatusValeId = 2,
                            Archivado = false,
                            Descripcion = "El vale ha sido revisado y confirmado por el director del departamento de proveeduría",
                            Nombre = "Validado"
                        },
                        new
                        {
                            EstatusValeId = 3,
                            Archivado = false,
                            Descripcion = "El vale a sido entregado correctamente al solicitante",
                            Nombre = "Entregado"
                        },
                        new
                        {
                            EstatusValeId = 4,
                            Archivado = false,
                            Descripcion = "El solicitante entregó el vale al departamento de proveeduría",
                            Nombre = "Recibido"
                        });
                });
            ...
            modelBuilder.Entity("AtoGobMx.Models.PROV_Vehiculo", b =>
                {
                    b.Property<int>("ProvVehiculoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProvVehiculoId");

                    b.HasIndex("ControlValeId");

                    b.HasIndex("VehiculoId");

                    b.ToTable("PROV_Vehiculo");
                });
            ...
            modelBuilder.Entity("AtoGobMx.Models.ArchivosMobiliario", b =>
                {
                    b.HasOne("AtoGobMx.Models.PAT_Mobiliario", "Mobiliario")
                        .WithMany()
            ...
            modelBuilder.Entity("AtoGobMx.Models.PAT_Vehiculo", b =>
                {
                    ...
                    b.HasOne("AtoGobMx.Models.PROV_Proveedor", "Proveedor")
                        .WithMany("PAT_Vehiculo")
            ...
            modelBuilder.Entity("AtoGobMx.Models.PROV_Vehiculo", b =>
                {
                    b.HasOne("AtoGobMx.Models.PROV_ControlVales", "ControlDeVales")
                        .WithMany("PROV_Vehiculo")
                        .HasForeignKey("ControlValeId");
